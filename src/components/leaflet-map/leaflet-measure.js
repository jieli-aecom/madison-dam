// Source: https://github.com/ptma/Leaflet.Measure/tree/master
// License: MIT License
// With modifications
...
(function (factory, window) {
  ...
  L.Control.Measure = L.Control.extend({
    ...
    _buildContainer: function () {
      ...
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M200-160v-340q0-142 99-241t241-99q142 0 241 99t99 241q0 142-99 241t-241 99H200Zm80-80h260q108 0 184-76t76-184q0-108-76-184t-184-76q-108 0-184 76t-76 184v260Zm260-120q58 0 99-41t41-99q0-58-41-99t-99-41q-58 0-99 41t-41 99q0 58 41 99t99 41Zm0-80q-25 0-42.5-17.5T480-500q0-25 17.5-42.5T540-560q25 0 42.5 17.5T600-500q0 25-17.5 42.5T540-440ZM80-160v-200h80v200H80Zm460-340Z"/></svg>
      <span>${this.options.title || "Measurement"}</span>`;
      this._link.href = "#";
    ...
    _initLayout: function () {
      ...
      if (this.options.collapsed) {
        ...
        L.DomEvent.on(this._link, "click", L.DomEvent.preventDefault);
        L.DomEvent.on(
          this._link,
          "click",
          function () {
            if (
              L.DomUtil.hasClass(this._container, "leaflet-measure-expanded")
            ) {
              this._collapse();
            } else {
              this._expand();
        ...
        // Collapse on mouse leave from entire container
        L.DomEvent.on(this._container, "mouseleave", this._collapse, this);
      } else {
        this._expand();
      }
    },
  ...
  L.MeasureAction = L.Handler.extend({
    ...
    _getDistanceString: function (distance) {
      ...
      if (feet > FEET_IN_MILE) {
        return (
          this._numberFormat(feet / FEET_IN_MILE, L.Measure.mileDecimals) +
          " " +
          L.Measure.mile
        );
      } else {
        return (
          this._numberFormat(feet, L.Measure.feetDecimals) +
          " " +
          L.Measure.feet
        );
      }
    ...
    _getAreaString: function (points) {
      ...
      const sqft = a * SQFT_IN_SQM;
      if (sqft > SQFT_IN_ACRE) {
        const acres = sqft / SQFT_IN_ACRE;
        return (
          this._numberFormat(acres, L.Measure.acresDecimals) +
          " " +
          L.Measure.acres
        );
      } else {
        return (
          this._numberFormat(sqft, L.Measure.sqftDecimals) +
          " " +
          L.Measure.sqft
        );
      }
