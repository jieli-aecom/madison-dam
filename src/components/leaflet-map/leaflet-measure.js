  ...
  L.MeasureAction = L.Handler.extend({
      ...
      _getDistanceString: function (distance) {
          ...
          if (feet > FEET_IN_MILE) {
            return this._numberFormat(feet / FEET_IN_MILE, L.Measure.mileDecimals) + " " + L.Measure.mile;
          } else {
            return this._numberFormat(feet, L.Measure.feetDecimals) + " " + L.Measure.feet;
          }
      },
      ...
      _getAreaString: function (points) {
          ...
          if (sqft > SQFT_IN_ACRE) {
            ...
            return this._numberFormat(acres, L.Measure.acresDecimals) + " " + L.Measure.acres;
          } else {
            return this._numberFormat(sqft, L.Measure.sqftDecimals) + " " + L.Measure.sqft;
          }
      },
